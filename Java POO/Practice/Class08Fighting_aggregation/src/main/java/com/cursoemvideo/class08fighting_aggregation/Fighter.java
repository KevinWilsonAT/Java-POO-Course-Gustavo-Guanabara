...
public class Fighter {
    ...
    public void display(){
        System.out.print("From this side of the ring we have the Fighter " + this.getName() + ", ");
        System.out.println("From " + this.getNationality() + ", " + this.getAge() + " years old.");
        System.out.println("With a height of " + this.getHeight() + "m and a weight of " + this.getWeight() + "kgs.");
        System.out.println("This fighter has " + this.getWins() + " wins, " + this.getLosses() + " losses and " + this.getDraws() + " draws.");
        System.out.println("===========================================");
    }
